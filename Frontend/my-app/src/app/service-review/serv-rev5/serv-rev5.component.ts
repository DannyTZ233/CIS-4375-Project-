...
// @Component({
//   selector: 'app-serv-rev5',
//   templateUrl: './serv-rev5.component.html',
//   styleUrls: ['./serv-rev5.component.css']
// })
// export class ServRev4Component implements OnInit {
