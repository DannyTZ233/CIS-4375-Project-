...
@Component({
  selector: 'app-service-q4',
  templateUrl: './service-q4.component.html',
  styleUrls: ['./service-q4.component.css']
})
export class ServiceQ4Component implements OnInit {
  ...
  ngOnInit(): void {
    this.customer_id = 1;
      this.service_review_question_id=4;
